...
aus_image=ImageTk.PhotoImage(Image.open("australia.png"))
jap_image=ImageTk.PhotoImage(Image.open("japan.png"))
...
class Japan():
    def times(self):
        ...
        local_time=datetime.now(home)
        current_time=local_time.strftime("%H:%M:%S")
        jap_time["text"]="Time : "+current_time
        jap_time.after(200,self.times)
obj_india=India()
obj_usa=USA()
obj_aus=Australia()
obj_jap=Japan()
